...
export function top(i) {
  return _top(i);
}
export function topLeft(i) {
  return _topLeft(i);
}
export function topRight(i) {
  return _topRight(i);
}
...
export function bottom(i) {
  return _bottom(i);
}
export function bottomRight(i) {
  return _bottomRight(i);
}
export function bottomLeft(i) {
  return _bottomLeft(i);
}
